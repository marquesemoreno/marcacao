...
| Hospedagem | Vercel, ou Docker Compose auto-hospedado | ✅ Vercel configurado, domínio oficial `https://conectasaudevc.com.br` — ver [[10 - Central de Testes e Acessos]] · ✅ `docker-compose.prod.yml` (App + Postgres + Nginx) pronto, não testado com Docker de verdade — ver [[01 - Setup e Infraestrutura]] |
