      ...
      <DialogContent className="max-w-lg rounded-3xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label htmlFor="clinic-trade-name" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                Nome Fantasia *
              </label>
              <input
            ...
            <div>
              <label htmlFor="clinic-legal-name" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                Razão Social *
              </label>
              <input
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="sm:col-span-1">
              <label htmlFor="clinic-cnpj" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                CNPJ *
              </label>
              <input
                id="clinic-cnpj"
            ...
            <div>
              <label htmlFor="clinic-phone" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                Telefone
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                />
              </div>
            </div>
            <div>
              <label htmlFor="clinic-whatsapp" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                WhatsApp Recepção
              </label>
              <input
                id="clinic-whatsapp"
          ...
          <div className="space-y-3 pt-1 border-t border-slate-100 dark:border-slate-800">
            <div>
              <label htmlFor="clinic-address" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                Endereço Completo *
              </label>
              <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label htmlFor="clinic-neighborhood" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                  Bairro *
                </label>
                <input
              ...
              <div>
                <label htmlFor="clinic-city" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                  Cidade *
                </label>
                <input
                  id="clinic-city"
              ...
              <div>
                <label htmlFor="clinic-commission" className="text-[11px] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block mb-1">
                  Comissão (%) *
                </label>
                <div className="relative">
                  <Percent className="w-3.5 h-3.5 absolute left-3 top-3 text-slate-400 dark:text-slate-500" />
                  <input
                    id="clinic-commission"
                    name="commissionRate"
                    type="number"
                    step="0.01"
                    min="0"
                    ...
                    defaultValue="15"
                    required
                    className="w-full pl-8 pr-3 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 text-xs font-bold font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                  />
                </div>
              </div>
            </div>
