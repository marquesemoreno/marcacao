...
export function HospitalIntegrationModal({ clinicId, clinicName }: { clinicId: string; clinicName: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-cyan-700 bg-cyan-50 hover:bg-cyan-100 border border-cyan-200 rounded-xl transition-all cursor-pointer">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-2 text-xs font-medium rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500"
                />
              </div>
              <div>
