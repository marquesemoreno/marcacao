    ...
    >
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="reschedule-doctor" className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
              Médico
            </label>
            <select
              ...
              className="w-full mt-1 px-3 py-2 text-xs font-medium rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
            >
          ...
          <div>
            <label htmlFor="reschedule-date" className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
              Data afetada
            </label>
            <input
              id="reschedule-date"
          ...
          {doctorName && date && (
            <div>
              ...
              <div className="mt-1 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden max-h-40 overflow-y-auto">
                {loadingPreview ? (
          ...
          <div>
            <label htmlFor="reschedule-template" className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
              Mensagem
            </label>
            <textarea
              ...
              className="w-full mt-1 px-3 py-2 text-xs font-medium rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 resize-none"
            />
            <p className="mt-1 text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center justify-end gap-2">
            <DialogClose className="px-3 py-2 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg">
              Cancelar
            </DialogClose>
            <button
              type="button"
              ...
              onClick={handleSend}
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-white bg-amber-600 hover:bg-amber-700 disabled:opacity-50 rounded-lg transition-all"
            >
