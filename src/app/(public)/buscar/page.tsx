    ...
    <main className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-8 sm:px-6">
      <div className="space-y-3">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          Navegue pelas especialidades credenciadas, consulte procedimentos e solicite agendamentos com atendimento no seu WhatsApp.
        </p>
      ...
      <div className="flex items-center justify-between border-b border-slate-200/80 pb-3 text-xs text-slate-600 font-semibold">
        <div className="flex items-center gap-1.5">
          ...
          <span>
            {results.length} {results.length === 1 ? "procedimento disponível no catálogo" : "procedimentos disponíveis no catálogo"}
          </span>
        </div>
      </div>
